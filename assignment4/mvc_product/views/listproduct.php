...
<body>
    ...
    <div class="container" style="padding: 50px 10px">
        <a href="?route=editproduct"><button class="btn btn-primary" style="margin-bottom: 20px">Thêm mới</button></a>
        <a href="?route=listcart"><button class="btn btn-info" style="margin-bottom: 20px"><i class="bi bi-cart"></i></button></a>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="?route=addcart" method="post">
                            <input type="hidden" name="id" value="<?php echo $item["id"] ?>"/>
                            <button type="submit" style="border: none; background-color: unset"><i class="bi bi-cart-plus"></i></button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
